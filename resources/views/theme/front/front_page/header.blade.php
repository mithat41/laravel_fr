        ...
        <div class="container">
            <div class="row small-gutters">
                <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                    <div id="logo">
                        <a href="index.html"><img src="{{ asset('theme/img/logo.svg') }}" alt="" width="100" height="35"></a>
                    </div>
                </div>
                <nav class="col-xl-6 col-lg-7">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <a href="index.html"><img src="{{ asset('theme/img/logo_black.svg') }}" alt="" width="100" height="35"></a>
                                    ...
                                    <div class="row small-gutters">
                                        ...
                                        <div class="col-lg-3 d-xl-block d-lg-block d-md-none d-sm-none d-none">
                                            <div class="banner_menu">
                                                <a href="#0">
                                                    <img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('theme/img/banner_menu.jpg') }}" width="400" height="550" alt="" class="img-fluid lazy">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="product-detail-1.html">
                                                <figure><img src="{{ asset('theme/img/products/product_placeholder_square_small.jpg') }}" data-src="{{ asset('theme/img/products/shoes/thumb/1.jpg') }}" alt="" width="50" height="50" class="lazy"></figure>
                                        ...
                                        <li>
                                            <a href="product-detail-1.html">
                                                <figure><img src="{{ asset('theme/img/products/product_placeholder_square_small.jpg') }}" data-src="{{ asset('theme/img/products/shoes/thumb/2.jpg') }}" alt="" width="50" height="50" class="lazy"></figure>
